...
private Connection con;
    ...
    public void connectie() throws ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost/Skittle?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC\n", "root", "");

        Statement st = con.createStatement();
        String sql = ("SELECT * FROM Proces ORDER BY ID DESC LIMIT 1;");
